...
<div class="wrap">
    <h1 class="wp-heading-inline">Danh Sách contact</h1>
    ...
    <form id="posts-filter" method="get">
        ...
        <p class="search-box">
            <label class="screen-reader-text" for="post-search-input">Tìm email, tên:</label>
            <input type="search" id="post-search-input" name="s" value="">
            <input type="submit" id="search-submit" class="button" value="Tìm liên hệ"></p>
