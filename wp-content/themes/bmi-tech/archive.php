        ...
        <div class="row">
            <div class="col-md-4" style="background: #E3EDF6">
                ...
                <?php for ($i = 0; $i < 2; $i ++): ?>
                    ...
                    <div class="row paint-text" style="margin-left: 0px;margin-bottom: 20px;background-image: url('https://satmythuathd.files.wordpress.com/2015/08/loi-son-tinh-dien.jpg');">
            ...
            <div class="col-md-8">
                ...
                <?php if ( have_posts() ) : ?>
                    ...
                    <?php
                        $thumb = get_post_thumbnail_id('news_thumb');
                        ?>
