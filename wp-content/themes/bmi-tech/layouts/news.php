<script>
    $(document).ready(function(){
        ...
        var newSlider = $('.newslider').bxSlider({
            pager: false,
            controls: false,
            slideMargin: 20,
            startSlide: 1,
        ...
        <?php if (wp_is_mobile()): ?>
        var currentW = $(".itembxslider").width();
        var newW = currentW * 100 /94;
        // alert(currentW.toFixed(0));
        $(".itembxslider").width(newW.toFixed(0))
        <?php endif; ?>

        $(".newslider").css('transform', 'translate3d(0px, 0px, 0px)');
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12" style="margin-bottom: 20px;">
                <img src="<?= get_template_directory_uri() . '/assets/images/icon/nextpre.png'; ?>" style="float: right; width: 50px; height: 25px;" usemap="#nexprev1">
                <map name="nexprev1">
