...
class ThemexTweets extends WP_Widget {
	...
	function __construct() {
		$widget_ops=array('classname' => 'widget-twitter', 'description' => __('Shows your recent tweets', 'quangbinhtravel'));
		parent::__construct('widget-twitter', __('Recent Tweets','quangbinhtravel'), $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$instance=wp_parse_args((array)$instance, array(
			'title' => __('Recent Tweets', 'quangbinhtravel'),
			'number' => '3',
			'id' => '',
		));
		
		$title=apply_filters('widget_title', empty($instance['title'])?__('Recent Tweets', 'quangbinhtravel'):$instance['title'], $instance, $this->id_base);
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Widget ID', 'quangbinhtravel'); ?>:</label>
