...
class ThemexPosts extends WP_Widget {
	...
	function __construct() {
		$widget_ops=array('classname' => 'widget-selected-posts', 'description' => __('Posts from selected category', 'quangbinhtravel'));
		parent::__construct('widget-selected-posts', __('Selected Posts','quangbinhtravel'), $widget_ops);
