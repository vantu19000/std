...
class ThemexCore {
	...
	public static function upgrade() {
		...
		if(isset($_GET['upgraded'])) {
			...
			//$out.='Update the database to use quangbinhtravel 3.0, please make a backup before updating. <a href="'.admin_url('themes.php?activated=true&upgraded=true').'">Update Now</a>';
		}
	...
	public static function saveOptions() {
		...
		_e('All changes have been saved','quangbinhtravel');
		die();		
	}
	...
	public static function resetOptions() {	
		...
		_e('All options have been reset','quangbinhtravel');
		die();
	}
