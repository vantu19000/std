...
class ThemexWoo {
	...
	public static function renderSettings() {
		...
		$out.=ThemexInterface::renderOption(array(	
			'name' => __('Show Country', 'quangbinhtravel'),
		...
		$out.=ThemexInterface::renderOption(array(	
			'name' => __('Show City', 'quangbinhtravel'),
		...
		$out.=ThemexInterface::renderOption(array(
			'name' => __('Show State', 'quangbinhtravel'),
		...
		$out.=ThemexInterface::renderOption(array(
			'name' => __('Show Address', 'quangbinhtravel'),
		...
		$out.=ThemexInterface::renderOption(array(	
			'name' => __('Show Postcode', 'quangbinhtravel'),
		...
		$out.=ThemexInterface::renderOption(array(	
			'name' => __('Show Company', 'quangbinhtravel'),
		...
		$out.=ThemexInterface::renderOption(array(
			'name' => __('Show Phone', 'quangbinhtravel'),
